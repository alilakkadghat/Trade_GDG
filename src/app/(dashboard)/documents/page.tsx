            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground px-1">
                {["Upload", "Extraction", "Cross-Validation", "Report"].map((step, i) => (
                    <div key={step} className="flex items-center gap-2">
                        <span
                            className={`h-5 w-5 grid place-items-center rounded-full text-[10px] font-medium ${i < 3
                            ...
                            {validationResults.map((r, i) => {
                                ...
                                return (
                                    <tr key={i} className="align-top hover:bg-surface">
                                        ...
                                        <td
                                            className={`px-3 py-4 font-mono text-xs ${r.status === "MISMATCH" || r.status === "MISSING"
                                        ...
                                        <td className="px-3 py-4 pr-6">
                                            {r.status === "OK" ? (
                                                ...
                                                <button
                                                    className={`text-xs font-medium hover:underline ${tone === "critical"
                                                            ? "text-on-destructive-container"
