...
import { UploadCloud, Plus, Eye, FileText, Ship, Package, ScrollText } from "lucide-react";
    ...
    <div className="space-y-6 max-w-[1400px] mx-auto">
      ...
      <Card className={`transition-colors ${dragOver ? "bg-secondary-container/40" : ""}`}>
        ...
        >
          ...
          {files.length > 0 && (
            <div className="mt-6 text-xs text-muted-foreground">Queued: {files.join(", ")}</div>
          )}
        </div>
      </Card>
      ...
      <div>
        <h3 className="text-sm font-medium text-foreground mb-3">Documents in this Shipment</h3>
