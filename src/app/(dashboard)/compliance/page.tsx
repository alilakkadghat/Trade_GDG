        ...
        <div className="space-y-6">
                ...
                <label key={item} className="flex items-start gap-3 text-sm cursor-pointer group">
                  ...
                  <span
                    className={`text-foreground ${
                      done[item] ? "line-through text-muted-foreground" : ""
                    }`}
                  >
                    {item}
                  </span>
          ...
          <Card>
            ...
            <p className="mt-3 text-xs text-muted-foreground leading-relaxed">
              Two minor items pending: Dutch label translation and APEDA RCMC reference on shipping
              bill. Resolve before vessel cut-off (06 May, 18:00 IST).
            </p>
          </Card>
        </div>
      </div>
