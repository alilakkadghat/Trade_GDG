                        ...
                        <div className="flex items-center gap-1.5 overflow-x-auto pb-1 sm:pb-0 w-full sm:w-auto hide-scrollbar">
                            {categories.map((c) => (
                                <button
                                    key={c}
                                    onClick={() => setFilter(c)}
                                    className={`px-3 py-1.5 rounded-full text-[13px] whitespace-nowrap transition-colors ${filter === c
                ...
                <div className="space-y-6 hidden lg:block">
                    ...
                    <Card>
                            ...
                            {[
                                ...
                                <div key={l.lane} className="flex items-center justify-between">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <div
                                            className={`text-[10px] uppercase font-bold ${l.trend.startsWith("+") ? "text-on-destructive-container" : "text-muted-foreground"
                                                }`}
                                        >
                                            {l.trend}
                                        </div>
                        ...
                        <div className="mt-4 pt-4 border-t border-ghost">
                            <a href="#" className="text-xs font-medium text-on-secondary-container hover:underline">
