      ...
      <section className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6">
        ...
        <Card className="p-0 overflow-hidden">
          <div className="px-6 pt-6 pb-4 flex items-baseline justify-between">
            ...
            <Link to="/documents" className="text-xs text-on-secondary-container hover:underline">
              View all →
            </Link>
          </div>
          ...
          <Card>
            ...
            <div className="mt-4 space-y-4">
              {[
                ...
                { icon: CalendarDays, label: "CBAM filing due", detail: "Q1 emissions report · 30 May" },
