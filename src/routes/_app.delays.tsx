...
const cargoLocations = ["At Warehouse", "At CFS / ICD", "Port Terminal", "On Vessel", "At Destination Port"];
          ...
          <div className="space-y-6">
            <Card>
              ...
              <p className="mt-3 text-sm text-foreground leading-relaxed">
                ...
                affected by an MSC blank sailing for the Asia–North Europe AE-7 service. Next
                direct sailing departs 12 May. A transhipment routing via Colombo (Maersk SAFARI
                service) is available 09 May with 5 additional days transit and €700/TEU premium.
              </p>
            </Card>
                  ...
                  <tbody className="text-foreground">
                    ...
                    <tr className="bg-surface">
                      <td className="py-3 px-2 rounded-l-md">
                        ...
                        <span className="ml-2"><Badge tone="success">Recommended</Badge></span>
                      </td>
            ...
            <Card>
              ...
              <p className="mt-4 text-xs text-muted-foreground">
                Based on 142 historical resolutions of MSC blank sailings on AE-7 service in last
                18 months. 89% confidence interval.
              </p>
            </Card>
          </div>
        )}
