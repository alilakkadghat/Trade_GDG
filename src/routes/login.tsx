...
export const Route = createFileRoute("/login")({
  component: LoginPage,
  head: () => ({ meta: [{ title: "Sign in — TradeBot" }] }),
});
      ...
      <div className="hidden lg:flex flex-col justify-between p-14 bg-primary text-primary-foreground">
        ...
        <div className="max-w-md">
          ...
          <p className="mt-6 text-sm text-primary-foreground/70 leading-relaxed">
            TradeBot is the intelligence layer between your shipping desk and the world's
            customs authorities. Cross-validate documents, decode destination compliance, and
            resolve delays with playbooks that ship.
          </p>
        </div>

        <div className="text-[11px] text-primary-foreground/50">
          © 2026 TradeBot · Mumbai
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          >
            ...
            <div>
              <div className="flex items-baseline justify-between">
                ...
                <a className="text-[11px] text-on-secondary-container hover:underline">
                  Forgot?
                </a>
              </div>
              <input
          ...
          <p className="mt-8 text-xs text-muted-foreground text-center">
            New to TradeBot?{" "}
            <Link to="/signup" className="text-on-secondary-container hover:underline">
              Create an account
            </Link>
          </p>
        </div>
