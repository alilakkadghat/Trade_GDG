...
export const Route = createFileRoute("/landing")({
    ...
    head: () => ({
        meta: [{ title: "TradeBot — The world's trade, always on." }],
    }),
});
    ...
    return (
        <main className="landing-theme relative min-h-screen overflow-hidden bg-[hsl(160_45%_5%)] text-[hsl(150_30%_92%)]">
            ...
            <div className="absolute inset-0 landing-animate-fade-in-slow">
                <Suspense
                    fallback={<div className="h-full w-full bg-[hsl(160_45%_5%)]" />}
                >
                    <Globe />
                </Suspense>
            </div>
            ...
            <div
                ...
                style={{
                    backgroundImage:
                        "radial-gradient(hsl(150 80% 60% / 0.6) 1px, transparent 1px)",
            ...
            <section className="relative z-10 flex min-h-[calc(100vh-160px)] flex-col items-center justify-center px-6 text-center">
                ...
                >
                    The world's trade,{" "}
                    <span className="landing-text-gradient">always on.</span>
                </h1>
                ...
                >
                    Live shipment signals across Mumbai, Dubai, Singapore, Hamburg and
                    every major port — streamed to one calm gateway.
                </p>
